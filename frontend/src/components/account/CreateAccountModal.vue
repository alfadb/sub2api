<template>
  ...
  >
    ...
    >
      ...
      <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <!-- Mixed Scheduling (for antigravity/copilot accounts) -->
        <div v-if="form.platform === 'antigravity' || form.platform === 'copilot'" class="flex items-center gap-2">
...
const mixedScheduling = ref(false) // For antigravity/copilot accounts: enable mixed scheduling
...
const needsMixedChannelCheck = (platform: AccountPlatform) => platform === 'antigravity' || platform === 'anthropic' || platform === 'copilot'

<template>
  ...
  <!-- Copilot (cpu) -->
  <svg v-else-if="platform === 'copilot'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
    <path
  ...
  <!-- Aggregator (swap) -->
  <svg v-else-if="platform === 'aggregator'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
    <path
      stroke-linecap="round"
      stroke-linejoin="round"

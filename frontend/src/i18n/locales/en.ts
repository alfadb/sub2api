  ...
  admin: {
    ...
    accounts: {
      ...
      deviceAuth: {
        ...
        step2: 'Wait for Authorization',
        code: 'Device Code',
        link: 'Verification Link',
        instructions: 'Please click the button below to open GitHub, paste the code, and authorize the application.',
        openLink: 'Open GitHub Verification Page',

...
export type GroupPlatform = 'anthropic' | 'openai' | 'copilot' | 'aggregator' | 'gemini' | 'antigravity'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'copilot' | 'aggregator' | 'gemini' | 'antigravity'

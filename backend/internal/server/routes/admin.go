...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/:id/github/device/start", h.Admin.Account.StartGitHubDeviceAuth)
		accounts.POST("/:id/github/device/poll", h.Admin.Account.PollGitHubDeviceAuth)
		accounts.POST("/:id/github/device/cancel", h.Admin.Account.CancelGitHubDeviceAuth)
		...
		accounts.POST("/:id/models/refresh", h.Admin.Account.RefreshAvailableModels)
